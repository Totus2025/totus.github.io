...
// Siempre muestra el círculo de carga en el botón "Ingresar" durante el proceso de login
function showLoading(button, textElement, spinner) {
  button.disabled = true;
  textElement.style.display = 'none';
  spinner.innerHTML = `<span class="loading" style="display:inline-block;width:24px;height:24px;border-width:4px;vertical-align:middle;"></span>`;
}
